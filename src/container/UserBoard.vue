<template>
  <div id = 'right-col-user-board'>
    ...
    <ul
      ...
      class = 'h-list no-margin no-padding user-board-bottom-span'
    >
      <li
    ...
    <ul
      ...
      class = 'h-list no-padding mlra user-board-bottom-span'>
      <li>
        <a 
...
export default {
  ...
  computed: {
    pendingNumber: function() {
      return [
        this.pendingStatus.confirm,
        this.pendingStatus.ship,
        this.pendingStatus.pay,
...
#right-col-user-board-login-controls > li > a{
  display: block;
  width: 100%;
}
a.clickable {
